        ...
        with FileLock(lock_path):
            try:
                if os.path.exists(cached_features_file) and not args.overwrite_cache:
                    ...
                    raise FileNotFoundError("Cache file not found or overwrite_cache is True")
            except (FileNotFoundError, pickle.UnpicklingError, EOFError) as e:
                logger.warning(f"Cache file {cached_features_file} not found or corrupted. Creating new features.")
